...
<li  data-toggle="collapse" data-target="#report" class="navio">
      ...
      <a href="/active" class="navio" style="width: 110% ; margin-left: -10%"><i  class="fa fa-rocket" aria-hidden="true" fa-3x></i>&nbsp;Active codes</a>
       <a href="/inactive" class="navio" style="width: 110% ; margin-left: -10%"><i class="fa fa-ban" aria-hidden="true"></i>&nbsp;Inactive codes</a>
         <a href="/notification" class="navio" style="width: 110% ; margin-left: -10%"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i>&nbsp;Invalid codes</a>
       </ul>
